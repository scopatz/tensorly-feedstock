...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/tensorly-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/tensorly-feedstock)
...
Once the `conda-forge` channel has been enabled, `tensorly` can be installed with:

```
conda install tensorly
```

It is possible to list all of the versions of `tensorly` available on your platform with:
